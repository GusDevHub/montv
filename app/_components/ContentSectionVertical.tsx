...
export default function ContentSectionVertical({
    viewallText,
    sectionName,
    data,
    selectedIndex,
...
}: ContentSectionVerticalProps) {
    return (
        <div className="flex items-center justify-between gap-4 md:gap-2 my-2 md:my-4 pr-3 md:pr-12">
            {showViewAllAtStart && (
                <Link href="#" className="min-w-[155px] md:min-w-[155px] max-w-[155px] md:max-w-[155px] h-[248px] md:h-[380px] relative rounded-lg bg-cyan-950/25 p-3 border-transparent border-[2px] hover:border-teal-800 transition-transform transform hover:scale-110 focus:scale-110 hover:z-20 hover:ml-2">
            ...
            <Link href="#" className="hover:z-20 focus:z-20">
                <div className="min-w-[167px] md:min-w-64 max-w-28 md:max-w-80 rounded-lg bg-cyan-950/25 py-[91px] md:py-[145px] border-transparent border-[2px] hover:border-teal-800 transition-transform transform hover:scale-110 focus:scale-110 hover:z-20 text-center text-base md:text-xl">
